                ...
                @if ($post->status === 'published')
                    <div class="flex items-center justify-between mt-3 px-3">
                        <div class="flex items-center">
                            <a href="javascript:;" class="text-xs text-gray-500 relative mr-3" 
                                id="post-views-container"
                                x-data="{ tooltip: false }"
                                x-on:mouseover="tooltip = true"
                                x-on:mouseleave="tooltip = false"
                            >
                                <x-tooltip :message="'This post has ' . $post->view_count . ' views'" class="w-48 -left-20" />
